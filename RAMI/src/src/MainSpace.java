...
//        String data = "data/test.json"; //pour paul sinon ça marche pas
        ...
        try (FileReader reader = new FileReader(data)) {
            ...
            while (model.getSolver().solve()) {
                ...
                Graph<GraphModelisation_double_bonds.Node, DefaultEdge> graph1 = GraphModelisation_double_bonds.translate((GraphVar) vars[1], atom.listTypes(),liaisons);
                ...
                if (new_g) {
                    ...
                    String graphe_visualized = GraphModelisation_double_bonds.getGraphViz(graph1);
